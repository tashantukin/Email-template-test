                            ...
                            <div class="col-md-12">
                                 <div class="row">
                                    ...
                                    <div class="form-group form-group-border col-sm-8">
                                        ...
                                        <input class="form-control" type="text" name="pg_title" id="title" required="" maxlength="70" value="<?php echo $templateContent['Records'][0]['title']; ?>">
                                        </div>
                                ...
                                <div class="form-group form-group-border">
                                    ...
                                    <input class="form-control" type="text" name="pg_title" id="description" required="" maxlength="110" value="<?php echo $templateContent['Records'][0]['description']; ?>">
                                </div>
