    ...
    <div class="gutter-wrapper">
      <div class="panel-box">
        <div class="page-content-top">
          ...
          <div>
            <p>Add new Email templates to your marketplace</p>
          </div>
          ...
          <table id="no-more-tables1">
            <thead>
              <tr>
                ...
                <th id="page-title">Template Title<i class="icon icon-white-up"><i class="icon icon-white-down"></i></i></th>
              ...
              <tr>
                ...
                foreach ($files as $file) {
                  ...
                  if (strpos($file, '.html') !== false) {
                    $search = '.html';
                    $templateName = str_replace($search, '', $file);
                    echo  "<td style='padding-right:15px'>" .  $templateName . "</td>";
                    echo "<td>";
                    echo  "<ul id='filename'>";
                    echo   $file;
                    echo "</ul>";
